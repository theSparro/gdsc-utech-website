...
function Footer() {
	return (
		<div className="Footer">
			...
			<a href="https://discord.gg/PmpsEKJn3j" target="_blank">
				Discord
			</a>
			<a href="https://www.instagram.com/gdsc.utechja/" target="_blank">
				Instagram
			</a>
			<a
			...
			<a href="https://github.com/gdsc-utech" target="_blank">
				GitHub
			</a>
			<a
